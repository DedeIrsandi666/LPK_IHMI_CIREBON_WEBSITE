@extends('layout')
@section('title', 'LPK IHMI CIREBON')
...
<head>
    ...
    <title>Halaman Admin LPK IHMI CIREBON</title>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{asset('assets1/images/logo-icon.png')}}" alt="homepageclass="dark-logo" />
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('peserta.index') }}" aria-expanded="false">
                                <i class="me-3 fa fa-user" aria-hidden="true"></i><span
                                    class="hide-menu">Daftar Profil Peserta</span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
        ...
        {{-- <div class="page-wrapper">
            ...
            {{-- <footer class="footer text-center">
                © 2023 Website LPK IHMI CIREBON by Mahasiswa <a href="https://www.cic.ac.id/welcome/">cic.ac.id</a>
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
